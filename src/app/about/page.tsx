        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-4">關於 CTF 線上工具</h1>
            ...
            <div className="space-y-8">
              ...
              <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">專案介紹</h2>
              ...
              {/* Features */}
              <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">功能特色</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-teal-600 mb-2">🔐 編碼工具</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-teal-600 mb-2">🔢 密碼學演算法</h3>
                    <ul className="text-gray-700 space-y-1">
                      <li>• 古典密碼 (凱薩、維吉尼亞等)</li>
                      <li>• 替換密碼 (仿射、柵欄等)</li>
                      <li>• 特殊編碼 (摩斯、敲擊碼)</li>
              ...
              {/* Technology */}
              <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">技術架構</h2>
                <div className="text-gray-700 space-y-4">
                  <p>本專案採用現代化的前端技術架構建置：</p>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                      <div className="text-2xl mb-2">⚛️</div>
                      <div className="font-semibold">React 19</div>
                      <div className="text-sm text-gray-600">使用者介面</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                      <div className="text-2xl mb-2">🔺</div>
                      <div className="font-semibold">Next.js 15</div>
                      <div className="text-sm text-gray-600">全端框架</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                      <div className="text-2xl mb-2">🎨</div>
                      <div className="font-semibold">Tailwind CSS</div>
                      <div className="text-sm text-gray-600">樣式框架</div>
                    </div>
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                      <div className="text-2xl mb-2">📘</div>
                      <div className="font-semibold">TypeScript</div>
                      <div className="text-sm text-gray-600">型別安全</div>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="bg-teal-50 border border-teal-200 rounded-lg p-6">
                <h2 className="text-2xl font-semibold text-teal-900 mb-4">開源專案</h2>
              ...
              <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">意見回饋</h3>
                    ...
                    <ul className="text-gray-700 space-y-1">
                      ...
                      <li>💬 QQ群: 364788699</li>
                      <li>🐙 GitHub: github.com/ctf-tools</li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">支持專案</h3>
                    <p className="text-gray-700 mb-2">
