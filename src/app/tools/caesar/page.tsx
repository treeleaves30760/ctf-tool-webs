        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={mode === 'encrypt' ? '請輸入要加密的文字...' : '請輸入要解密的密文...'}
                  />
                </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-yellow-900 mb-3">凱薩密碼說明</h3>
              <div className="text-yellow-800 space-y-2">
                <p><strong>原理:</strong> 凱薩密碼是一種簡單的字母替換密碼，通過將字母按照固定偏移量進行移位。</p>
                <p><strong>歷史:</strong> 據說凱薩大帝使用偏移量為3的密碼來保護軍事通訊。</p>
                <p><strong>破解:</strong> 由於只有25種可能的偏移量，可以通過暴力破解輕鬆解密。</p>
