...
export default function MorseTool() {
  ...
  const decodeFromMorse = (morse: string): string => {
    ...
    return words.map(word => {
      ...
      const codes = word.split(separator).filter(code => code.trim() !== '');
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={mode === 'encode' ? '請輸入要編碼的文字...' : '請輸入摩斯電碼... (用 / 分隔單詞)'}
                  />
                </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-amber-900 mb-3">摩斯電碼說明</h3>
              <div className="text-amber-800 space-y-2">
                <p><strong>歷史:</strong> 由塞繆爾·摩斯在1830年代發明，用於電報通訊。</p>
                ...
                <div className="bg-amber-100 p-3 rounded mt-3">
                  ...
                  <p className="text-sm font-mono">HELLO: .... . .-.. .-.. ---</p>
                </div>
              </div>
            </div>
          </div>
