...
export default function URLTool() {
  ...
  const [encoding, setEncoding] = useState<'standard' | 'component' | 'form'>('standard');
      ...
      if (mode === 'encode') {
        switch (encoding) {
          ...
          case 'component':
            ...
            break;
          case 'form':
            setOutput(input.replace(/ /g, '+').replace(/[^A-Za-z0-9+]/g, (char) => {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-4">URL編碼工具</h1>
              <p className="text-gray-600">支援標準URL編碼、組件編碼和表單編碼</p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <select
                    value={encoding}
                    onChange={(e) => setEncoding(e.target.value as 'standard' | 'component' | 'form')}
                    className="bg-white text-black border border-gray-300 rounded-md px-3 py-1 text-sm focus:ring-teal-500 focus:border-teal-500"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={mode === 'encode' ? '請輸入要編碼的文字...' : '請輸入要解碼的URL編碼文字...'}
                  />
                </div>
            ...
            {/* Character Reference */}
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">常見字元編碼對照</h3>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-green-900 mb-3">URL編碼說明</h3>
              <div className="text-green-800 space-y-3">
                <div>
                  <p><strong>編碼類型區別:</strong></p>
                  <ul className="list-disc ml-6 mt-1 space-y-1">
                    <li><strong>標準URL編碼 (encodeURI):</strong> 保留URL中的保留字元（如 :/?#[]@）</li>
                    <li><strong>組件編碼 (encodeURIComponent):</strong> 編碼所有非字母數字字元，用於URL參數</li>
                    <li><strong>表單編碼:</strong> 類似組件編碼，但將空格轉換為 + 號</li>
                  </ul>
                </div>
                ...
                <div className="bg-green-100 p-3 rounded mt-3">
                  ...
                  <p className="text-sm"><strong>原文:</strong> Hello World! 你好</p>
                  <p className="text-sm"><strong>標準編碼:</strong> Hello%20World!%20%E4%BD%A0%E5%A5%BD</p>
                  <p className="text-sm"><strong>組件編碼:</strong> Hello%20World!%20%E4%BD%A0%E5%A5%BD</p>
                  <p className="text-sm"><strong>表單編碼:</strong> Hello+World%21+%E4%BD%A0%E5%A5%BD</p>
                </div>
              </div>
            </div>
          </div>
