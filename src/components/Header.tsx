        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-black">CTF Tools</span>
            </Link>
          </div>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex space-x-8">
            <Link href="/" className="text-black hover:text-teal-600 transition-colors">
              首頁
            </Link>
            <div className="relative group">
              <button className="text-black hover:text-teal-600 transition-colors flex items-center space-x-1">
                <span>工具箱</span>
              ...
              <div className="absolute top-full left-0 mt-1 w-64 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="p-4">
                  <div className="space-y-3">
                    <div>
                      <h3 className="text-sm font-semibold text-black mb-2">CTF編碼</h3>
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-black mb-2">CTF演算法</h3>
                      <div className="space-y-1 text-sm text-black">
            ...
            <Link href="/about" className="text-black hover:text-teal-600 transition-colors">
              關於
            </Link>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200">
            <nav className="space-y-2">
              <Link href="/" className="block py-2 text-black hover:text-teal-600 transition-colors">
                首頁
              </Link>
              <Link href="/tools" className="block py-2 text-black hover:text-teal-600 transition-colors">
                工具箱
              </Link>
              <Link href="/about" className="block py-2 text-black hover:text-teal-600 transition-colors">
                關於
              </Link>
            </nav>
          </div>
